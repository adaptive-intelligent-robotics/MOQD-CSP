...
def force_threshold_exp(
    plot_individually=True, force_thesh=True, relax_steps=True, relax_steps_no_10=True
):
    ### 1 - Force Threshold
    ...
    report_generator = ReportPlotGenerator(
        ...
        / ".experiment.nosync/report_data/1_force_threshold",
        plot_labels=None,
        title_tag=None,
    )
    if force_thesh:
        report_generator.plot_combined_figure_for_report(
            ...
            y_limits_dict={"Maximum Fitness": [9.3, 9.42]},
        )
    if relax_steps:
        report_generator.plot_combined_figure_for_report(
            folder_names=[
                "threshold_1_10_relax",
                "threshold_1_50_relax",
                "threshold_1",
            ],
    ...
    if relax_steps_no_10:
        report_generator.plot_combined_figure_for_report(
            folder_names=["threshold_1_50_relax", "threshold_1"],
