...
if __name__ == '__main__':
    ...
    print(experiment_parameters.system_name)
    ...
    if MaterialProperties.ENERGY_FORMATION in experiment_parameters.cvt_run_parameters[
    ...
    max_archive = max([int(name.lstrip("archive_").rstrip(".pkl")) for name in
                       os.listdir(f"{experiment_directory_path}") if
                       ((not os.path.isdir(name)) and ("archive_" in name))])
