...
if __name__ == "__main__":
    ...
    path_to_main_folder = (
        ...
        / ".experiment.nosync"
        / "report_data/1_force_threshold/threshold_02"
    )
    ...
    (
        ...
        plot_descriptors,
        labels_for_plotting,
    ) = archive_with_energy_fitness.convert_fitness_and_descriptors_to_plotting_format(
        all_centroids
    )
    (
        plot_fitness_normal,
        plot_descriptors_normal,
        labels_for_plotting_normal,
    ) = archive.convert_fitness_and_descriptors_to_plotting_format(all_centroids)
