...
def force_vs_dqd(plot_individually=True, exp_1=True):
    ...
    if exp_1:
        report_generator.plot_combined_figure_for_report(
            folder_names=[
                "force_only", "force_only_batch_10", #"force_only_simple_batch_10", "dqd_lr1_100_relax_batch_10",  #"dqd_lr_1_simple",  # "force_only_no_relax_batch_10",
            ],
            labels=["Batch 100", "Batch 10", ], # "No Relax Batch 10",
            title_tag="",
