...
def dqd(plot_individually=True, lr=True, relax_steps=True, batch_size=True,
    ...
    if relax_steps:
        report_generator.plot_combined_figure_for_report(
            folder_names=[
                "lr1_50_relax", "lr_1", # "lr1_10_relax",
            ],
    ...
    if batch_size:
        report_generator.plot_combined_figure_for_report(
            folder_names=[
                "lr1_100_relax_batch_10", "lr1_100_relax_batch_20", "lr_1",
            ],
    ...
    if dqd_rattle:
        report_generator.plot_combined_figure_for_report(
            folder_names=[
                "lr1_100_relax_batch_10", "5050_with_rattle"
            ],
...
if __name__ == '__main__':
    dqd(plot_individually=False, lr=False, relax_steps=False, batch_size=True, dqd_rattle=False)
