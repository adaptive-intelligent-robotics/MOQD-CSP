...
def relaxation_exp(plot_individually=True, relax_archive_every_5=True, relax_steps=True,
    ...
    if relax_archive_every_5:
        report_generator.plot_combined_figure_for_report(
            folder_names=[
                "relax_10_always_archive_20_every_5", "relax_10_always_archive_50_every_5", "relax_archive_50_every_5"
            ],
    ...
    if archive_relax_no_intermediate_relax:
        report_generator.plot_combined_figure_for_report(
            ...
            labels=["10 Every 5 Generations", "10 Every 10 Generations", "50 Every 5 Generations", "50 Every 10 Generations"],
